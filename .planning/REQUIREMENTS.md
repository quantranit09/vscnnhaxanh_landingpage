...
- [X] **LAYOUT-01**: Header sticky hiển thị logo Nhà Xanh + menu điều hướng (smooth scroll đến sections)
- [X] **LAYOUT-02**: Header chứa hotline rõ ràng, click-to-call (`tel:`) hoạt động trên mobile
- [X] **LAYOUT-03**: Footer hiển thị địa chỉ, giờ phục vụ, hotline, Zalo, Messenger, copyright
- [X] **LAYOUT-04**: Floating button Zalo + hotline cố định góc phải màn hình, luôn hiển thị khi scroll
