...
import { trackFormSubmit, trackPhoneClick, submitPhoneLead } from "@/lib/gtag";
...
export function Contact() {
  ...
  // Fire Google Ads conversion when Formspree confirms success
  useEffect(() => {
    if (state.succeeded) {
      trackFormSubmit();
    }
    ...
    <section className="py-20 md:py-28 bg-[#FAFCFB] border-t border-emerald-50">
      <div className="container max-w-[1200px]">
        ...
        <div className="grid lg:grid-cols-5 bg-white rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] overflow-hidden border border-gray-100">
              ...
              <div className="space-y-8">
                {contactInfo.map((info, idx) => (
                  <div key={idx} className="flex gap-4 items-start group">
                    ...
                    />
                    <div>
                      <h4 className="text-emerald-100/70 text-xs font-bold uppercase tracking-wider mb-1.5">
                        {info.title}
                      </h4>
                      <p className="font-medium whitespace-pre-line leading-snug text-white/95 text-[15px]">
                        {info.detail}
                      </p>
                    </div>
                  </div>
          ...
          <div
            id="lien-he"
            className="lg:col-span-3 p-8 md:p-12 lg:p-14 xl:p-16 flex flex-col justify-center scroll-mt-24"
          >
            {state.succeeded ? (
              <motion.div
              ...
              >
                ...
                <p className="text-gray-500 mb-10 leading-relaxed text-[17px]">
                  Yêu cầu của bạn đã được ghi nhận. Chuyên viên Nhà Xanh sẽ liên
                  hệ với bạn trong ít phút tới.
                </p>
                <Button
              ...
              <>
                ...
                <div className="bg-emerald-50 border-2 border-emerald-200 rounded-3xl p-5 mb-6 text-center">
                  ...
                  >
                    <div className="relative">
                      ...
                      <Phone
                        size={26}
                        className="fill-[#2D8B3A] relative z-10"
                      />
                    </div>
                ...
                <div className="flex items-center gap-4 mb-5">
                  ...
                  <span className="text-gray-400 text-sm font-medium px-1">
                    hoặc để lại số, chúng tôi gọi lại
                  </span>
                  <hr className="flex-1 border-gray-200" />
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="mb-6">
                    <h3 className="text-[26px] font-extrabold text-gray-900 mb-1.5 tracking-tight">
                  ...
                  <div className="relative group">
                    <div className="rounded-2xl bg-gray-50/50 border-2 border-gray-200 px-5 py-4 focus-within:bg-white focus-within:border-[#2D8B3A] focus-within:ring-4 focus-within:ring-[#2D8B3A]/10 transition-all duration-200">
                      <label
                        htmlFor="phone"
                        className="block text-[11px] font-bold text-emerald-600 uppercase tracking-widest mb-1.5"
                      >
                    ...
                    {phoneWarning && (
                      <p className="text-amber-500 text-xs mt-1.5 ml-2 font-medium">
                        {phoneWarning}
                      </p>
                    )}
                    <ValidationError
                  ...
                  {state.errors && state.errors.getFormErrors().length > 0 && (
                    <div className="bg-red-50 text-red-600 p-4 rounded-2xl text-sm border border-red-100 flex items-start gap-3 mt-4">
                      ...
                      <span>
                        <span className="font-bold">Lỗi:</span> Không thể kết
                        nối.
                      </span>
                    </div>
                  )}
                  ...
                  <p className="text-[12px] text-center text-gray-400 font-medium mt-2">
                    ...
                    <a
                      ...
                      className="underline underline-offset-2 hover:text-[#2D8B3A] transition-colors"
                    >
                      chính sách bảo mật
                    </a>
                    .
